...
We have several different steering systems across boats.

## Steering wire

They can generally all use the same wire: 2 mm high-grade [PVC-coated stainless rope (7x7)][wire-rope]. Ideally we buy this direct (~£0.44/m) rather than paying about £3/m from a rowing shop.

[wire-rope]: https://www.wireropeshop.co.uk/clear-coated-pvc-stainless-steel-wire-rope-7x7/ -->
...
**Check:** No wobble; symmetric placement.
[!/PROCEDURE]
...
4. Attach at the rudder yoke; set equal tension left/right and verify full travel.
5. Secure and finish cable ends (ferrules + tape/heatshrink) so there are no sharp strands.

**Check:** Rudder centred when toe centred; smooth travel; no snagging or slack. Replace when frayed/snapped or if centring repeatedly drifts.
[!/PROCEDURE]
